...
#ifndef WXLIQUIDGLASSBRIDGE_SWIFT_H
#define WXLIQUIDGLASSBRIDGE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="wxLiquidGlassBridge",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
#undef SWIFT_SYMBOL
#endif
#define SWIFT_SYMBOL(usrValue) SWIFT_SYMBOL_MODULE_USR("wxLiquidGlassBridge", usrValue)
...
#endif
#ifdef __cplusplus
namespace wxLiquidGlassBridge SWIFT_PRIVATE_ATTR SWIFT_SYMBOL_MODULE("wxLiquidGlassBridge") {
namespace _impl {
extern "C" {
#endif

SWIFT_EXTERN void $s19wxLiquidGlassBridge05SwiftD4TestyyF(void) SWIFT_NOEXCEPT SWIFT_CALL; // SwiftBridgeTest()
...
SWIFT_INLINE_THUNK void SwiftBridgeTest() noexcept SWIFT_SYMBOL("s:19wxLiquidGlassBridge05SwiftD4TestyyF") {
  wxLiquidGlassBridge::_impl::$s19wxLiquidGlassBridge05SwiftD4TestyyF();
}


} // namespace wxLiquidGlassBridge
